USE shampoos;
INSERT INTO shampoos.labels(id, title, subtitle)
...
USE shampoos;
INSERT INTO shampoos.ingredients(id, name, price)
VALUES (1, 'Apple', '0.50'),
(2, 'Nettle', '0.70'),
...
INSERT INTO shampoos.shampoos(id, brand, price, size, label_id)
...
INSERT INTO shampoos_ingredients(shampoo_id, ingredient) VALUES
(1, 1), (1, 2), 
(2, 3),
(3, 11), (3, 5), 
(4, 11), (3, 6), 
